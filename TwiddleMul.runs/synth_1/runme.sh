...
HD_PWD='C:/Users/nel-araby/TwiddleMul/TwiddleMul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TwiddleX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TwiddleX.tcl
