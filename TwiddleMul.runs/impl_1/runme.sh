...
HD_PWD='C:/Users/nel-araby/TwiddleMul/TwiddleMul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TwiddleX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TwiddleX.tcl -notrace
